...
Future<User> fetchUser(String uName) async {
  final response =
      await http.get(Uri.parse('http://10.0.2.2:8070/users/getUser/$uName'));
...
class _BodyState extends State<Profile> {
  ...
  bool res = false;
  Future updateUser(String userName, String firstName, String lastName,
      String password) async {
    final response = await http.put(
      Uri.parse('http://10.0.2.2:8070/users/update/$userName'),
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => Welcome(uName: userName)));
    } else {
  ...
  Future deleteUser(String userName) async {
    final response = await http.delete(
      Uri.parse('http://10.0.2.2:8070/users/delete/$userName'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
      body: jsonEncode(<String, String>{}),
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          children: <Widget>[
            const Align(
                alignment: Alignment.topLeft, child: Text("Profile Details")),
            Align(
                ...
                return Column(children: <Widget>[
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                        ...
                        contentPadding: EdgeInsets.fromLTRB(5, 12, 12, 12)),
                    readOnly: true,
                  ),
                  TextField(
